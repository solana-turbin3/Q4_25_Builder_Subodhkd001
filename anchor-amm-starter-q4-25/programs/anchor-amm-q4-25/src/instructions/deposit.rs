...
impl<'info> Deposit<'info> {
    pub fn deposit(
        ...
        {
            true => (max_x, max_y), // this is at the start when pool is empty; deposit equal ammounts
            false => {
                // here we are providing the state of the pool and getting the x and y ammounts
